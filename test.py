...
class FlashcardApp:
    def __init__(self):
        ...
        # Create a PhotoImage object for the tick image
        self.tick_image = ImageTk.PhotoImage(file="tick_image.png")
    ...
    def knowledge(self):
        ...
        # Display the tick image next to the "I know this" button
        self.knowledge_button.config(image=self.tick_image, state="disabled")
    ...
    def next_word(self):
        ...
        # Reset the "I know this" button to its original state
        self.knowledge_button.config(image='', state="normal")
